...
const ProjectCardRight = ({
  ...
  return (
    <div className="mb-10 lg:mb-20">
      <span className="text-2xl lg:text-3xl text-sky-400 mx-4 sm:mx-20">{title}</span>
      <div className="flex flex-col justify-center items-center lg:flex-row mx-4 md:mx-20 lg:my-0 sm:my-2">
        <div className="flex flex-col lg:items-end lg:relative lg:right-16 lg:top-6 sm:w-4/5 z-10 order-2">
          <div className=" border-l border-b border-r border-t rounded-lg  mt-4 border-sky-400 drop-shadow-[0_5px_35px_rgba(255,255,255,0.25)] ">
            <div className=" bg-slate-800 rounded-lg py-2 flex items-center">
            ...
            <div className="px-6 py-3 h-32 overflow-auto bg-slate-950 text-gray-400">
              {description}
            </div>
          </div>
        ...
        <img
          className="border-2 sm:w-4/5 lg:w-2/4 drop-shadow-[0_5px_35px_rgba(255,255,255,0.25)]  border-slate-900 rounded-2xl hover:border-sky-400"
          src={image}
          alt=""
        />
      </div>
