...
const About = () => {
  return (
    <div id="about" className="flex flex-col justify-center items-center mb-20">
      ...
      <div className="text-2xl mt-8 flex flex-col items-center ">
        <div id="skills" className="text-3xl mb-4"> Skills</div>
        <div className="flex justify-center items-center py-5  ">
          <div className="text-center ">
            <DiHtml5
              size={90}
              className="mx-6 p-1 bg-sky-400 text-slate-950"
              style={{
          ...
          <div className="text-center">
            <DiCss3Full
              size={90}
              className="p-1 mx-6 bg-sky-400 text-slate-950"
              style={{
                 boxShadow: "0 0px 35px rgba(255, 255, 255, 0.5)",
              }}
            />
          ...
          <div className="text-center">
            <DiJavascript1
              size={90}
              className="mx-6 bg-sky-400 text-slate-950"
              style={{
                 boxShadow: "0 0px 35px rgba(255, 255, 255, 0.5)",
              }}
            />
          ...
          <div className="text-center">
            <SiPostman
              size={90}
              className="p-3 mx-6 bg-sky-400 text-slate-950"
              style={{
                 boxShadow: "0 0px 35px rgba(255, 255, 255, 0.5)",
              }}
            />
